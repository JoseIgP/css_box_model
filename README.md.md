...
XII. Utilice la propiedad de borde correcta para establecer el color del borde en "rojo".
...
XVI. Establezca el relleno superior del elemento `<h1>` en 30 píxeles.
...
XIX. Establezca el ancho del elemento `<div>` en "200px".
